...
window.addEventListener("load", function() {
    ...
    const $search_icon = document.querySelector("#click-to-search");
    const $ = document.querySelector("#click-to-search");
    const $search_box = document.querySelector("div.col div.parent-box-ip");
    const $click_focus_input = document.getElementById("click-to-focus");
    $search_icon.addEventListener("click", function() {
        ...
        if($attr_icon === "fa-solid fa-magnifying-glass") {
            ...
            $search_icon.setAttribute("class", "fa-solid fa-magnifying-glass");
        }
        
        $search_box.classList.toggle("show-search");
        $click_focus_input.focus();
    });
