...
window.addEventListener("load", function() {
    ...
    const $click_focus_input = document.querySelector("#click-to-focus");
    $click_focus_input.addEventListener("focusin", function(){
        $click_focus_input.for (const item of object) {
